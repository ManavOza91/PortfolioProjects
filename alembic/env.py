...
The connection URL comes from config.yaml (or SIGNAL_ENGINE_DATABASE_URL) rather
than alembic.ini, so there is exactly one place the database is configured.
"""
